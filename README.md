...
| Telegram-бот + качалка / Telegram bot + downloader | **owner priority** (son's request): specs approved 2026-09-19 ([bot](docs/superpowers/specs/2026-09-19-telegram-family-bot-design.md), [downloader](docs/superpowers/specs/2026-09-19-home-downloader-design.md)); implementation plan is next, deploy only on "деплой" |
