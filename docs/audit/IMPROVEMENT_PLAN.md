...
|---|---|---|---|
| F-01/F-03 | Fail-closed dumps: `pg_isready` wait, min size, `gzip -t`, systemd After/Pre | shell fixture empty gzip | **CLOSED 2026-09-09** git+device (`nasa-backup.service`, live dump OK) |
