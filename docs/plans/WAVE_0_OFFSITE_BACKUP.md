...
> ⚠️ **2026-09-04 — LEGACY for NAS architecture (ADR-0007 / ADR-0009).**  
> 🇷🇺 Vostro **исключён** из модели узлов NAS. Актуальный план бэкапов:  
> L1 Immich→HDD Jetson; L2 off-site → Cloud.ru S3.  
> См. [`DEVELOPMENT_PLAN_2026-09_SBER_ERA.md`](DEVELOPMENT_PLAN_2026-09_SBER_ERA.md).  
> Фаза 1 на Vostro (дампы БД) может ещё работать исторически — не канон.
>
...
> `*.sql.gz` прошли `gzip -t`). Подробности — раздел «Сделано 2026-08-24» ниже.
